...
==На первом этапе лучше использовать форму или несколько форм в Pyrus, которые будут служить хранилищем метаданных, логов обработки тикетов, результатов категоризации и истории обновлений RAG. Это позволит отслеживать метрики эффективности бота и анализировать качество ответов.==
